...
export const emailRegistro = async ({ email, nombre, token }) => {
  ...
  const info = await transport.sendMail({
    from: '"HabitacionesApp - Administrador de Habitaciones" <cuentas@habitacionesapp.com>',
    to: email,
    subject: "HabitacionesApp - Confirma tu Cuenta",
    text: "Comprueba tu cuenta en HabitacionesApp",
    html: `<!DOCTYPE html>
																...
																<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																	<div style="font-family: sans-serif">
																		<div class style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																			<p style="margin: 0; font-size: 12px; text-align: left; mso-line-height-alt: 18px;">Para utilizar el servicio y formar parte de HabitacionesApp debes confirmar tu correo.</p>
																		</div>
																	</div>
																</td>
															</tr>
...
export const emailOlvidePassword = async ({ email, nombre, token }) => {
  ...
  const info = await transport.sendMail({
    from: '"HabitacionesApp - Administrador de Habitaciones" <cuentas@habitacionesapp.com>',
    to: email,
    subject: "HabitacionesApp - Restablece tu Cuenta",
